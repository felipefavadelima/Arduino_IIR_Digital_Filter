...
First the signal is filtered through a resonator set to the frequency of 70Hz, then the signal is rectified, and finally, the signal passes through a 0.5Hz low-pass filter. 
The output signal is tested, if it is higher than a certain threshold, the led on pin 13 lights up. 
