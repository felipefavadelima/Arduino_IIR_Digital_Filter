...
def genArduinoIno(sos32,FName, FN, Fc_Hz,Fs_Hz):
    ...
    #header
    CodeString = '//ButterWorth high Pass Filter\n'
...
if __name__ == "__main__":
    ...
    if(len(Arguments) == 5):
        ...
        print('High Pass Butterwoth Arguments:');
        print('Name:', FName);
        ...
        print('Arguments Error!\n',
              'Example: "python BPButter.py Name n Fc_Hz Fs_Hz"\n',
              'Name - Filter Name',
              'N - Filter Order\n',
              'Fc_Hz - Cutoff Frequency (-3dB)\n',
              'Fs_Hz - Sampling Frequency\n',
              'Example: "python HPButter.py HP 4 50 1000"');
