...
def genArduinoIno(sos32,FName, FN, Fc1_Hz,Fc2_Hz,Fs_Hz):
    ...
    #header
    CodeString = '//ButterWorth band stop Filter\n'
...
if __name__ == "__main__":
    ...
    if(len(Arguments) == 6):
        ...
        print('Band stop Butterwoth Arguments:');
        print('Name:', FName);
        ...
        print('Arguments Error!\n',
              'Example: "python BSButter.py Name n Fc1_Hz Fc2_Hz Fs_Hz"\n',
              'Name - Filter Name',
              'N - Filter Order\n',
              'Fc1_Hz - Cutoff Frequency (-3dB)\n',
              'Fc2_Hz - Cutoff Frequency (-3dB)\n',
              'Fs_Hz - Sampling Frequency\n',
              'Example: "python BSButter.py BS 4 50 100 1000"');
